...
public class DeleteBusLogger {
    ...
    @Pointcut("execution (* com.example.demo.Controllers.BusController.deleteBus(..)) && args(id,..)")
    public void callBusDelete() {}

    @Before("callCustomerDelete()")
    ...
    public void saveLogToFile() throws Exception {
        String logMessage = "Bus deleted successfully!\n";
