...
@Aspect
@Component
public class DeleteRouteLogger {
    ...
    @Pointcut("execution (* com.example.demo.Controllers.RouteController.cancelRoute(..)) && args(id,..)")
    public void callRouteCancel() {}

    @Before("callRouteCancel()")
    ...
    @After("callRouteCancel()")
    public void saveLogToFile() throws Exception {
        String logMessage = "Route canceled successfully!\n";
