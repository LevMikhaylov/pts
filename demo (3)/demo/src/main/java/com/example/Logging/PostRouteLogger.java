...
public class PostBusLogger {
    ...
    @Pointcut("execution (* com.example.demo.Controllers.RouteController.launchRoute(..)) && args(route,..)")
    public void callLaunchRoute() {}

    @Before("callLanchRoute()")
    ...
    @After("callLanchRoute()")
    public void saveLogToFile() throws Exception {
        String logMessage = "Route launched successfully!\n";
